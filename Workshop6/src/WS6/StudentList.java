...
public class StudentList extends ArrayList<Student> {
    ...
    public void addStudent() {
        ...
        do {
            newCode = Inputter.inputPattern("Student code (s000 or S000): ", "[sS]\\d{3}");
        ...
        newName = validateName(newName); // Kiểm tra tên hợp lệ
    ...
    // Validate name to ensure the first character is capitalized
    private String validateName(String name) {
        ...
        if (name.length() > 0) {
            ...
            if (Character.isUpperCase(name.charAt(0))) {
                ...
                return Inputter.inputNonBlankStr("Name of new student: ");
            }
        } else {
            System.out.println("Invalid name. Please enter a non-blank name.");
            return Inputter.inputNonBlankStr("Name of new student: ");
        }
    }
}
